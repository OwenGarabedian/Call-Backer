            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-3xl font-black font-display text-foreground leading-none">{DEMO_STATS.totalCustomers}</div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-3xl font-black font-display text-foreground leading-none">{DEMO_STATS.engagedPercent}%</div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-3xl font-black font-display text-foreground leading-none">{DEMO_STATS.appointments}</div>
                </div>
              </motion.div>
            </div>
